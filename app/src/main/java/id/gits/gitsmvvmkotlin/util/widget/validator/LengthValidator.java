...
/**
 * Validator to set length constraints to the associated {@link CustomTextInputLayoutGits}
 *
 * @see BaseValidator
 */
public class LengthValidator extends BaseValidator {
    ...
    /**
     * Check if the associated {@link CustomTextInputLayoutGits} meets the length constraint
     * associated with it.
     *
